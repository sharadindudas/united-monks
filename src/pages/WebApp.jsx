                    ...
                    <div className="container clearfix">
                        <div className="ui__banner">
                            ...
                            <h1 className="text-white">
                                <span className="green">Demand Next-gen</span>{" "}
                                <span className="white last__child">
                                    Web Application for Your Brand
                                </span>
                            </h1>
                            <ul>
                                <li>
            ...
            <div id="main__content">
                    ...
                    <div className="container">
                        <div className="section">
                            <div className="ecommerce_solution_content">
                                <h2>
                                    Want to rise above the competition and
                                    attract customers? If yes,
                                    <Link to="/services">We can help?</Link>
                                </h2>
                                <p>
                                    We are a team of experienced web architects
                                    and engineers who understand your
                                    requirements and build a trusted
                                    user-friendly and cost-effective product.
                                    Our team works dedicatedly to help you
                                    outperform the competition, reach your
                                    revenue goals, and, most importantly, turn
                                    your business idea into reality. It’s no
                                    wonder that we are trusted by some of the
                                    leading brands across the industry.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container" id="what_we_offer__section">
                    <div className="web_app_offer">
                        ...
                        <p>
                            As an experienced team of web application
                            developers, we address all your digital needs
                            according to your industry. After analyzing all the
                            specifics of your business, we propose a combination
                            of tools and methodology that is business-effective
                            while tackling your industrial challenges at the
                            same time.
                        </p>
                        <div className="web_app_offer_child row">
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 nopadding">
                                <div className="what_we_offer_child_content">
                                    <img
                                        src="/asset/web-app/cake-php-icon.png"
                                        alt="img"
                                    />
                                    <span>
                                        Cake PHP <br />
                                    ...
                                    <p>
                                        We build web applications that scale up
                                        with your business and allow you to meet
                                        the growing requirements of the industry
                                        and your customers.
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div className="carousel__item__container row">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                            <div className="portfolio__text">
                                                ...
                                                <p>
                                                    Poker classified is a team
                                                    of poker players and product
                                                    designers working to create
                                                    tools to empower online
