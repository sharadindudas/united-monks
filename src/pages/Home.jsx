...
function Home() {
    ...
    function setDate() {
        ...
        secondHand.style.transition =
            secondsDegree === 90 ? "all 0s" : "all 0.05s";
    ...
    useEffect(() => {
        document.title =
            "UI UX Design Agency | Offshore Software Development | Mobile App & Web Development";
        ...
        <div className="wrapper">
                ...
                <div className="side__panel__wrap">
                    ...
                    <div className="mobile__logo">
                        <a href="/" className="retina__logo">
                            <img
                                src="asset/unitedmonks-logo@2x.webp"
                                alt="img"
                            />
                        </a>
                    </div>
            ...
            <header className={`navbar__section ${scroll && "sticky__navbar"}`}>
                ...
                <ul className="nav__menu">
                    <li>
                        <Link
                            to="/"
                            className={`nav__link active ${scroll && "black"}`}
                        >
                            home
                        </Link>
                    </li>
                    <li>
                        <Link
                            to="/story"
                            className={`nav__link ${scroll && "black"}`}
                        >
                            our story
                        </Link>
                    </li>
            ...
            <section id="hero__section" className="clearfix gradient__bg">
                <div className="hero__right">
                    <h1 className="text">
                        Master crafters of digital experiences
                    </h1>
                ...
                <div className="hero__left">
                    <img
                        src="asset/unitedmonks-banner-logo.svg"
                        alt="United Monks"
                    />
                    <div className="hero__text">
                        <h2>
                            We are a Full Stack Development Agency{" "}
                            <span className="hero__text__span">
                                ready to{" "}
            ...
            <div id="main__content">
                ...
                <section id="looking__section" className="section">
                    <div className="container">
                        ...
                        <div className="looking__container">
                            <h2 className="looking__title">
                                Looking for a team to <br />
                                <span ref={el}></span>
                                <span className="typed-cursor">|</span> <br />
                                <Link to="/services">
                                    We can help<span className="green">.</span>
                                </Link>
                            </h2>

                            {/* Looking Paragraph */}
                            <div
                                className="looking__para"
                                data-aos="fade-up"
                                data-aos-duration="2000"
                            >
                                <p>
                                    In an industry crammed with development
                                    agencies in every nook and corner, United
                                    Monks stands a class apart. We not only
                                    offer a fixed price model but also provide
                                    remote teams that will join your business in
                                    any corner of the world. Defined by our
                                    professionalism and commitment to each
                                    project we undertake, we make your
                                    requirements the driving force behind our
                                    work. We work with businesses of all sizes,
                                    ranging from top MNCs to mid-sized
                                    enterprises to recent start-up, and our
                                    agile and transparent methodologies help you
                                    get the most out of the collaboration.
                                </p>
                            </div>

                            {/* Looking Button */}
                            <div
                                className="looking__button"
                                data-aos="fade-up"
                                data-aos-duration="2000"
                                data-aos-delay="50"
                            >
                                <Link to="/story" className="looking__btn">
                                    know more
                                </Link>
                            </div>
                    ...
                    <div className="container">
                        <div className="goodAt__container">
                            <div className="goodAt__text">
                                <h3 className="green text2">
                                    What we are good at
                                </h3>
                                <div
                                    className="goodAt__para"
                                    data-aos="fade-up"
                                    data-aos-duration="2000"
                                    data-aos-delay="50"
                                >
                                    <p className="text-white">
                                        We take your business right from
                                        ideation & strategy to final execution
                                        with a host of web solutions like Full
                                        stack development, UI/UX, DevOps,
                                        Influencer Marketing and more. And the
                                        best part? All these solutions are
                                        tailor-made for you. <br />
                                        That’s enough talking for the moment.
                                        Let’s bring our services into the
                                        spotlight.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-xl-3 col-lg-3 col-md-4 nopadding">
                            <div className="carousel__text">
                                <h2>
                                    Technologies <br /> we work on
                                    <span className="raleway green">.</span>
                                </h2>
                            </div>
                        </div>
                ...
                <section id="testimonial__section">
                    <h3>Testimonial</h3>
                    <div className="container">
                        <span className="green top__text">
                        ...
                        <div className="testimonial__container">
                            <div className="testimonial__carousel">
                                ...
                                <OwlCarousel
                                    className="owl-theme testi__carousel"
                                    loop={true}
                                    nav={false}
                                    margin={20}
                                    dots={true}
                                ...
                                >
                                    <div className="item">
                                        <div className="testimonial__item">
                                            <p>
                                                They are a nice bunch of young
                                                talents, always aspiring to
                                                deliver the best. They possess
                                                good aesthetic sense, will
                                                recommend them for all
                                    ...
                                    <div className="item">
                                        <div className="testimonial__item">
                                            <p>
                                                I had a great experience working
                                                with United Monks. Professional,
                                                friendly, responded in a timely
                                                manner and did a great job.
                                                Built and designed a website for
                                                us with a great UX/UI. Highly
                                                recommend.
                                            </p>
                                            <span className="green">
                                                Shaun Marriner
                                    ...
                                    <div className="item">
                                        <div className="testimonial__item">
                                            <p>
                                                ...
                                                interactive and always open to
                                                suggestions.
                                            </p>
                                            <span className="green">
                                                Pankaj Raghbeer
                        ...
                        <div className="container">
                            <div className="work_feature__total">
                                <div className="work_feature__text">
                                    <h2>
                                        You are bound <br /> to work with us
                                    </h2>
                            ...
                            <div className="work_feature__carousel">
                                <OwlCarousel
                                    ...
                                    autoplayHoverPause={true}
                                    navText={[
                                        "<img src='asset/left.png' alt='img' />",
                                        "<img src='asset/right.png' alt='img' />"
                                    ]}
                                >
                                    <div className="item">
                                        <div className="work_feature__itemContainer row">
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12 nopadding">
                                                <div className="work_feature__carousel_text bg__white">
                                                    ...
                                                    <p>
                                                        ‘Customer before
                                                        Everything’ - We’ve let
                                                        that motto guide us in
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12 nopadding">
                                                <div className="work_feature__carousel_text bg__white">
                                                    ...
                                                    <p>
                                                        ...
                                                        Agile Development, we
                                                        maintain utmost
                                                        transparency throughout
                                                        the project development
                                                        stage, while maintaining
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12 nopadding">
                                                <div className="work_feature__carousel_text bg__white">
                                                    ...
                                                    <p>
                                                        ...
                                                        hello to a team almost
                                                        as perfect as the
                                                        Avengers. With a
                                                        qualified and
                                                        professional team
                                                        working for you
                                                        remotely, you won’t have
                                                        to think about added
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12 nopadding">
                                                <div className="work_feature__carousel_text bg__white">
                                                    ...
                                                    <p>
                                                        ...
                                                        is complete. And if you
                                                        are looking to expand
                                                        your business, we’ll see
                                        ...
                                        <div className="work_feature__itemContainer row">
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12 nopadding">
                                                <div className="work_feature__carousel_text bg__white">
                                                    ...
                                                    <p>
                                                        Losing data because you
                                                        didn’t back it up is so
                                                        2012. But if you are
                                                        still stuck in the past,
                                                        allow us to be your
                                                        guiding monks who take
                                                        you to the future and
                                                        save you from mishaps
                                                        like losing precious
                                                        data.{" "}
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="work_feature__itemContainer row">
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12 nopadding">
                                                <div className="work_feature__carousel_text bg__white">
                                                    ...
                                                    <p>
                                                        They say quality over
                                                        quantity, but we say
                                                        quality over everything!
                                                        We will always keep your
                                                        unique business
                                                        requirements in mind and
                                                        deliver nothing but the
                                                        best.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="work_feature__itemContainer row">
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12 nopadding">
                                                <div className="work_feature__carousel_text bg__white">
                                                    ...
                                                    <p>
                                                        What happens in United
                                                        Monks, stays in United
                                                        Monks. Need further
                                                        assurance? Let’s sign an
                                                        NDA.
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="carousel__item__container row">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                            <div className="portfolio__text">
                                                <h4>Quid Tutor</h4>
                                                <p>
                                                    Quid Tutor is an online
                                                    teaching platform which
                                                    covers 45 minutes of
                                                    Tutoring at just £1
                                                </p>
                                                <span>UI/UX</span>
                                                <span>
                                    ...
                                    <div className="carousel__item__container row">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                            <div className="portfolio__text">
                                                ...
                                                <a
                                                    target="_blank"
                                                    href="https://www.fpvlifestyle.com/"
                                                    rel="noreferrer"
                                                >
                                                    VIEW WEBSITE
                                                </a>
                                    ...
                                    <div className="carousel__item__container row">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                            <div className="portfolio__text">
                                                <h4>Engage</h4>
                                                <p>
                                                    Engage is a FinTech platform
                                                    that leverages financial
                                                    institutions for tracking,
                                                    monitoring and generating
                                                    report for all international
                                                    payment transfers done
                                                ...
                                                <a
                                                    target="_blank"
                                                    href="https://www.unitedmonks.com/engage.php"
                                                    rel="noreferrer"
                                                >
                                                    VIEW CASE STUDY
                                                </a>
                                    ...
                                    <div className="carousel__item__container row">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                            <div className="portfolio__text">
                                                ...
                                                <a
                                                    target="_blank"
                                                    href="https://www.unitedmonks.com/mpg.php"
                                                    rel="noreferrer"
                                                >
                                                    VIEW CASE STUDY
                                                </a>
                                    ...
                                    <div className="carousel__item__container row">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                            <div className="portfolio__text">
                                                ...
                                                <a
                                                    target="_blank"
                                                    href="https://www.behance.net/gallery/97762167/Adfluence"
                                                    rel="noreferrer"
                                                >
                                                    VIEW CASE STUDY
                                                </a>
                                    ...
                                    <div className="carousel__item__container row">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                            <div className="portfolio__text">
                                                <h4>HealthSetGO</h4>
                                                <p>
                                                    HealthSetGo is India’s
                                                    largest healthcare
                                                    organization for schools
                                                    with the mission to nurture
                                                ...
                                                <a
                                                    target="_blank"
                                                    href="https://www.healthsetgo.com/"
                                                    rel="noreferrer"
                                                >
                                                    VISIT WEBSITE
                                                </a>
                        ...
                        <div className="call_to_action__container clearfix">
                            <div className="call__left bg__blue">
                                <div className="call__left__content">
                                    ...
                                    >
                                        ...
                                        <span>we&apos;ve made for others.</span>
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="call__right bg__green">
                                <div className="call__right__content">
                                    <Link to="/contact">
                                        Let’s build something if <br />
                                        <span>you are convinced.</span>
                                    </Link>
                                </div>
                            </div>
                        </div>
