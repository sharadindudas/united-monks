...
function Portfolio() {
    ...
    useEffect(() => {
        document.title =
            "Portfolio | Snapshots Of Our Most Prominent Work - United Monks";
        ...
        <div className="wrapper clearfix">
            ...
            <header className="header__section">
                ...
                <ul className="header__ul">
                    ...
                    <li>
                        <Link to="/portfolio" className="header__link active">
                            portfolio
                        </Link>
                    </li>
                    <li>
                        ...
                        <div className="portfolio__img__container row">
                            <div className="col-xl-6 col-md-6 col-sm-6 nopadding">
                                <div className="portfolio__img__left">
                                    ...
                                    <a
                                        href="https://www.behance.net/gallery/128340601/MyProGamer"
                                        className="portfolio__img__child"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        <div className="child__img">
                                            <img
                                                loading="lazy"
                                                src="asset/port__images/mpg_portfolio.webp"
                                                alt="img"
                                            />
                                    ...
                                    >
                                        <div className="child__img">
                                            <img
                                                loading="lazy"
                                                src="asset/port__images/njoy.gif"
                                                alt="img"
                                            />
                                            <div className="img__overlay">
                                                <p>
                                                    Njoy&apos;s is the leading
                                                    Kratom brand based out of
                                                    USA.{" "}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    >
                                        <div className="child__img">
                                            <img
                                                loading="lazy"
                                                src="asset/port__images/adfluance.webp"
                                                alt="img"
                                            />
                                            <div className="img__overlay">
                                                <p>
                                    ...
                                    >
                                        <div className="child__img">
                                            <img
                                                loading="lazy"
                                                src="asset/port__images/karbonnmobile.gif"
                                                alt="img"
                                            />
                                            <div className="img__overlay">
                                                <p>
                                                    ...
                                                    Karbonn Mobiles is one of
                                                    the frontliners of the
                                                    Indian mobile industry with
                                    ...
                                    <a
                                        href="https://www.behance.net/gallery/86932015/Ayam-Meditation-Website-Design-and-Development"
                                        className="portfolio__img__child"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        <div className="child__img">
                                            <img
                                                loading="lazy"
                                                src="asset/port__images/ayam_portfolio.webp"
                                                alt="img"
                                            />
                                            <div className="img__overlay">
                                                <p>
                                                    AyamMeditation, a
                                                    Mexico-based startup is on a
                                                    mission to deliver digital
                                                    experiences that are
                                                    carefully designed to enrich
                                                    customer&apos;s journey into
                                                    a well-being state.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <a
                                        href="https://www.behance.net/gallery/110706737/The-Bump-To-Baby-Co"
                                        className="portfolio__img__child"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        <div className="child__img">
                                            <img
                                                loading="lazy"
                                                src="asset/port__images/bumptobaby.webp"
                                                alt="img"
                                            />
                                            <div className="img__overlay">
                                                <p>
                                                    The Bump to Baby Co is the
                                                    Prenatal program that
                                                    focuses on developing and
                                                    enhancing your baby&apos;s
                                                    emotional, physical,
                                    ...
                                    >
                                        <div className="child__img">
                                            <img
                                                loading="lazy"
                                                src="asset/port__images/angesbags.gif"
                                                alt="img"
                                            />
                                            <div className="img__overlay">
                                                <p>
                                    ...
                                    >
                                        <div className="child__img">
                                            <img
                                                loading="lazy"
                                                src="asset/port__images/celestebox.webp"
                                                alt="img"
                                            />
                                            <div className="img__overlay">
                                                <p>
                                                    Celeste Box finds and
                                                    supplies fashion brands
                            ...
                            <div className="col-xl-6 col-md-6 col-sm-6 nopadding">
                                <div className="portfolio__img__right">
                                    <div className="portfolio__img__left">
                                        ...
                                        <a
                                            href="https://www.behance.net/gallery/86869395/Airline-Safety-Instruction-Card-Design"
                                            className="portfolio__img__child"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                                            <div className="child__img">
                                                <img
                                                    loading="lazy"
                                                    src="asset/port__images/sanjiv_goenka.webp"
                                                    alt="img"
                                                />
                                                <div className="img__overlay">
                                                    <p>
                                        ...
                                        >
                                            <div className="child__img">
                                                <img
                                                    loading="lazy"
                                                    src="asset/port__images/hsg_portfolio.gif"
                                                    alt="img"
                                                />
                                                <div className="img__overlay">
                                                    <p>
                                        ...
                                        <a
                                            href="http://www.vintage-bloom.com/"
                                            className="portfolio__img__child"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                                            <div className="child__img">
                                                <img
                                                    loading="lazy"
                                                    src="asset/port__images/vintagebloom.webp"
                                                    alt="img"
                                                />
                                                <div className="img__overlay">
                                                    <p>
                                                        Vintage bloom are the
                                                        people behind
                                                        Dubai&apos;s most
                                                        fabulous weddings,
                                                        events, or parties. They
                                                        take pleasure in luxury
                                                        and aesthetics and have
                                                        a passion for artistic
                                                        expression.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <a
                                            href="https://www.behance.net/gallery/79683765/Mycloudhospitality"
                                            className="portfolio__img__child"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                                            <div className="child__img">
                                                <img
                                                    loading="lazy"
                                                    src="asset/port__images/mycloud-hospitality.webp"
                                                    alt="img"
                                                />
                                                <div className="img__overlay">
                                                    <p>
                                                        Mycloud hospitality is a
                                                        global leader in
                                                        providing PMS and POS
                                                        solutions to the
                                                        hospitality industry
                                                        across UK, Asia, Africa,
                                                        and the Middle East.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <a
                                            href="https://www.behance.net/gallery/61256591/Consus-Global-Website-Design-and-Development"
                                            className="portfolio__img__child"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                                            <div className="child__img">
                                                <img
                                                    loading="lazy"
                                                    src="asset/port__images/consus.webp"
                                                    alt="img"
                                                />
                                                <div className="img__overlay">
                                                    <p>
                                        ...
                                        <a
                                            href="https://www.behance.net/gallery/79090163/Ms-Travel-Bee"
                                            className="portfolio__img__child"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                                            <div className="child__img">
                                                <img
                                                    loading="lazy"
                                                    src="asset/port__images/mstravelbee_portfolio.webp"
                                                    alt="img"
                                                />
                                                <div className="img__overlay">
                                                    <p>
                                                        A one of a kind an
                                                        exclusive women travel
                                                        portal which is an
                                                        alliance by the women,
                                                        of the women &amp; only
                                                        for the women
                                                        <br />
                                                    </p>
