        ...
        <div className="wrapper overflow">
            ...
            <header className="header__section">
                ...
                <ul className="header__ul">
                    ...
                    <li>
                        <Link to="/contact" className="header__link active">
                            contact
                        </Link>
                    </li>
                </ul>
                ...
                <div className="slider__container">
                    ...
                    <div className="container clearfix">
                        <div className="slider__text__container">
                            ...
                            <h2>
                                Say hello<span className="green">.</span>
                            </h2>
                            <div className="slider__caption">
                                A little interest goes a long way. So, if you’re
                                curious about us, want to collaborate with us,
                                or be part of the United Monks team, don’t
                                hesitate to reach out to us. Walk in, call us,
                                or drop us a line, we’ll be glad to hear from
                                you.{" "}
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="container">
                                <div className="contact__container row">
                                    <div className="col-xl-4 col-lg-4 col-md-4 nopadding">
                                        <div className="contact__child">
                                            <img
                                                loading="lazy"
                                                src="asset/seattle.png"
                                                alt="img"
                                            />
                                            <div className="contact__address">
                                                <h4>Seattle</h4>
                                                <p>
                                                    918 S Horton ST Suite 902,
                                                    <br />
                                                    Seattle, <br />
                                                    WA 98134
                                                </p>
                                                ...
                                                <div className="contact__address__child">
                                                    ...
                                                    <a
                                                        href="mailto:info@unitedmonks.com"
                                                        className="link"
                                                    >
                                    ...
                                    <div className="col-xl-4 col-lg-4 col-md-4 nopadding">
                                        <div className="contact__child">
                                            <img
                                                loading="lazy"
                                                src="asset/west-bengal.png"
                                                alt="img"
                                            />
                                            <div className="contact__address">
                                                <h4>Kolkata</h4>
                                                <p>
                                                    528 Vip Nagar, 3rd Floor,
                                                    <br />
                                                    Sector 3,
                                                    <br /> Kolkata-700100
                                                </p>
                                ...
                                <div className="section">
                                    <div className="contact__text">
                                        ...
                                        <p>
                                            Send us your details, and we’ll take
