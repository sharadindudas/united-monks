...
function Ui() {
    ...
    const scrollBehaviour = () => {
        ...
        sliderContainer.setAttribute(
            "style",
            `transform: translate3d(0px, ${pos1}px, 0px)`
        );
        ...
        <div className="ui__wrapper overflow">
            ...
            <header className="header__section">
                ...
                <ul className="header__ul">
                    ...
                    <li>
                        <Link to="/career" className="header__link">
                            career
                        </Link>
                    </li>
                    <li>
            ...
            <section id="slider__section">
                <div className="slider__container">
                    ...
                    <div className="container clearfix">
                        <div className="ui__banner">
                            ...
                            <h1 className="text-white">
                                <span className="green">Get a high-profit</span>{" "}
                                <span className="white last__child">
                                    UI and UX design
                                </span>
                            </h1>
                            <ul>
                            ...
                            <Link to="/contact" className="bg__green">
                    ...
                    <a
                        href="#content"
                        className="scroll__animation__parent tab__visible"
                    >
            ...
            <div id="main__content">
                    ...
                    <div className="container">
                        <div className="extrapadding">
                            <div className="ui_ux__container">
                                <h2>
                                    Is your product hard to use &amp; face high
                                    bounce rate?
                                    <Link to="/contact">We can help</Link>
                                </h2>

                                <p>
                                    At United Monks, we believe your product can
                                    be complex, but the UI design must be easy.
                                    We use an user-centered approach and proven
                                    CX/UX methodology to design and create
                                    successful solutions that match three
                                    perspectives: user needs, business goals,
                ...
                <section id="what_we_love__section">
                    <div className="container">
                        ...
                        <p>
                            Tough problems are our forte, whether that’s domain
                            complexity or human complexity (like facilitating
                            new behaviours).
                        </p>
                    </div>
                                ...
                                <div className="col-lg-6">
                                    <div className="ui_ux__info">
                                        ...
                                        <div className="info__top">
                                            ...
                                            <p className="info__subtitle">
                                                In this phase, our UX researcher
                                                employs a range of different
                                                discovery activities which
                                ...
                                <div className="col-lg-6">
                                    <div className="step__slider">
                                        ...
                                        >
                                            <div className="item">
                                                <img
                                                    src="/asset/ui-ux/step2.png"
                                                    alt="vector"
                                                />
                                            </div>
                                            <div className="item">
                                                <img
                                                    src="/asset/ui-ux/step3.png"
                                                    alt="vector"
                                                />
                                            </div>
                                            <div className="item">
                                                <img
                                                    src="/asset/ui-ux/step4.png"
                                                    alt="vector"
                                                />
                                            </div>
                                            <div className="item">
                                                <img
                                                    src="/asset/ui-ux/step10.png"
                                                    alt="vector"
                                                />
                                            </div>
                                        </OwlCarousel>
                                ...
                                <div className="col-lg-6">
                                    <div className="ui_ux__info">
                                        ...
                                        <div className="info__top">
                                            ...
                                            <p className="info__subtitle">
                                                Our strategist find out what
                                                stakeholders are trying to
                                                achieve with the content and
                                                analyze what content,
                                                competitors are producing, and
                                                after going through various
                                                editing and review processes the
                                                website copy is finalized
                                            </p>
                                            <ul className="info__list">
                                                <li className="info__item">
                                                    <p>Content audit</p>
                                ...
                                <div className="col-lg-6">
                                    <div className="step__slider">
                                        ...
                                        >
                                            <div className="item">
                                                <img
                                                    src="/asset/ui-ux/step5.png"
                                                    alt="vector"
                                                />
                                            </div>
                                            <div className="item">
                                                <img
                                                    src="/asset/ui-ux/step6.png"
                                                    alt="vector"
                                                />
                                            </div>
                                            <div className="item">
                                                <img
                                                    src="/asset/ui-ux/step7.png"
                                                    alt="vector"
                                                />
                                            </div>
                                        </OwlCarousel>
                            ...
                            <div className="row step__reverse">
                                <div className="col-lg-6">
                                    <div className="ui_ux__info">
                                        ...
                                        <div className="info__top">
                                            <h3 className="info__title">
                                                Creating High and Low Fidelity
                                                Wireframes
                                            </h3>
                                            <p className="info__subtitle">
                                                In the initial step, multiple
                                                ideas are generated so our
                                                designers start UX sketching by
                                                creating wireframes to consider
                                                different approaches and to
                                                decide which is the most
                                                efficient user journey to
                                                acheive the project goal.
                                            </p>
                                            <ul className="info__list">
                                                <li className="info__item">
                                                    <p>UX Sketching</p>
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="ui_ux__info">
                                        ...
                                        <div className="info__top">
                                            <h3 className="info__title">
                                                Designing User Interface or
                                                Visual Designs
                                            </h3>
                                            <p className="info__subtitle">
                                                We now create visual designs,
                                                focusing on the design
                                                aesthetics of the site and its
                                                related materials.
                                            </p>
                                            <ul className="info__list">
                                                <li className="info__item">
                            ...
                            <div className="row step__reverse">
                                <div className="col-lg-6">
                                    <div className="ui_ux__info">
                                        ...
                                        <div className="info__top">
                                            <h3 className="info__title">
                                                Interactive Proof Of Concept or
                                                IPoC
                                            </h3>
                                            <p className="info__subtitle">
                                                This is our bread and butter. At
                                                the end of this phase, we will
                                            </p>
                                            <ul className="info__list">
                                                <li className="info__item">
                                                    <p>
                ...
                <section id="why_chose_us__section">
                    <div className="container">
                        ...
                        <p>
                            We work exactly like an in-house UX team providing
                            guarantee of on-time and perfect output. Our team
                            includes professionals with multiple skill sets like
                            researchers, analysts, UX designers and visual
                            designers.
                        </p>
                        <ul className="text-white">
                            <li>
                                Seasoned UX professionals with design thinking
                                expertise{" "}
                            </li>

                            <li>
                                Business acumen and industry knowledge across
                                Education, Finance, Health and Technology
                                domains
                            </li>

                            <li>
                                Lean and Agile approach in product design to
                                optimize cost and faster delivery
                            </li>

                            <li>
                                Experience in designing and managing large
                                enterprise products
                            </li>
                            ...
                            <li>
                                You can start with just a two month retainer
                                contract
                            </li>
                        </ul>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-sm-6 col-md-4 col-lg-3">
                                <div className="why_container">
                                    <img
                                        src="/asset/ui-ux/contract.png"
                                        alt="vector"
                                    />
                                    <h2 className="why_heading">
                                        No Rigid <br /> Contract
                                    </h2>
                                    <p>
                                        No lock-in terms, no risk to your
                                        business. Just give one month&apos;s
                                        notice to terminate the work agreement.{" "}
                                    </p>
                                </div>
                            </div>
                            <div className="col-sm-6 col-md-4 col-lg-3">
                                <div className="why_container">
                                    <img
                                        src="/asset/ui-ux/artistic.png"
                                        alt="vector"
                                    />
                                    <h2 className="why_heading">
                                        Artistic <br /> Execution
                                    </h2>
                                    <p>
                                        We do it right the first time. Our
                                        designs don&apos;t just stand out but
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-3">
                                <div className="why_container">
                                    ...
                                    <p>
                                        We understand the privacy and
                                        confidentiality you would like us to
                                        maintain.
                                    </p>
                                </div>
                            </div>
                            <div className="col-sm-6 col-md-4 col-lg-3">
                                <div className="why_container">
                                    ...
                                    <p>
                                        As a team, we aim to exceed your
                                        expectations with our dedicated support
                                                ...
                                                <div className="portfolio__item__img">
                                                    ...
                                                    <div className="portfolio__item__parent">
                                                        ...
                                                        <div className="reveal__content">
                                                            <img
                                                                loading="lazy"
                                                                src="asset/portfolio__tab/1.jpg"
                                                                alt="img"
                                                            />
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="portfolio__item__img">
                                                    ...
                                                    <div className="portfolio__item__parent">
                                                        ...
                                                        <div className="reveal__content">
                                                            <img
                                                                loading="lazy"
                                                                src="asset/portfolio__tab/2.jpg"
                                                                alt="img"
                                                            />
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="portfolio__item__img">
                                                    ...
                                                    <div className="portfolio__item__parent">
                                                        ...
                                                        <div className="reveal__content">
                                                            <img
                                                                loading="lazy"
                                                                src="asset/portfolio__tab/3.jpg"
                                                                alt="img"
                                                            />
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="portfolio__item__img">
                                                    ...
                                                    <div className="portfolio__item__parent">
                                                        ...
                                                        <div className="reveal__content">
                                                            <img
                                                                loading="lazy"
                                                                src="asset/portfolio__tab/4.jpg"
                                                                alt="img"
                                                            />
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="portfolio__item__img">
                                                    ...
                                                    <div className="portfolio__item__parent">
                                                        ...
                                                        <div className="reveal__content">
                                                            <img
                                                                loading="lazy"
                                                                src="asset/portfolio__tab/5.jpg"
                                                                alt="img"
                                                            />
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="portfolio__item__img">
                                                    ...
                                                    <div className="portfolio__item__parent">
                                                        ...
                                                        <div className="reveal__content">
                                                            <img
                                                                loading="lazy"
                                                                src="asset/portfolio__tab/6.jpg"
                                                                alt="img"
                                                            />
                                                        </div>
                                                    </div>
