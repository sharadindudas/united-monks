    ...
    return (
        <div className="mobile__wrapper overflow">
            ...
            <div id="main__content">
                    ...
                    <div className="container">
                        <div className="section">
                            <div className="ecommerce_solution_content">
                                <h2>
                                    Want iOS &amp; Android mobile apps that
                                    users will love! <br />
                                    <Link to="/services">We can help?</Link>
                                </h2>
                                <p>
                                    We are a team of capable developers with
                                    proactive and innovative ideas. Our
                                    expertise in mobile App development goes
                                    beyond creating a compelling user interface.
                                    We take your unbaked mobile app vision and
                                    transform it into a high-end,
                                    customer-drawing, and secure application for
                                    iOS and Android.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="consumer_app_content row">
                                <div className="col-xl-6 col-lg-5 col-md-5 nopadding">
                                    <div className="consume_app_content_left">
                                        <img
                                            src="/asset/mobile-app/home_mobile.png"
                                            alt="img"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-6 col-lg-7 col-md-7 nopadding">
                                    <div className="consume_app_content_right">
                                        ...
                                        <p className="text-white">
                                            ...
                                            your customers, we build a mobile
                                            app that not only attracts them to
                                            explore your products and service
                                        ...
                                        <ul className="text-white">
                                            <li>
                                                Create a personalized theme and
                                                design
                                            </li>

                                            <li>
                                                Make it compatible across
                                                various devices
                                            </li>

                                            <li>
                                                Brainstorm and create an
                                            ...
                                            <li>
                                                Release them on Apple Store and
                                                Google Play Store
                                            </li>
                            ...
                            <div className="enterprise_app_content row">
                                <div className="col-sm-12 col-xs-12 nopadding mobile__visible">
                                    <div className="enterprise_app_content_right">
                                        <img
                                            src="/asset/mobile-app/enterprise-app-img.png"
                                            alt="img"
                                        />
                                    </div>
                                </div>
                                <div className="col-xl-6 col-lg-7 col-md-7 nopadding">
                                    <div className="enterprise_app_content_left">
                                        ...
                                        <p className="text-white">
                                            Focusing on the functional needs of
                                            your business, we develop a mobile
                                            app that increases efficiency,
                                            productivity, and employee
                                            satisfaction. Combining the core
                                            strengths of enterprise CRM, data
                                            analytics, and the latest mobile
                                            techniques, we aim to deliver an
                                ...
                                <div className="col-xl-6 col-lg-5 col-md-5 nopadding desktop__visible">
                                    <div className="enterprise_app_content_right">
                                        <img
                                            src="/asset/mobile-app/mpg_mobile.png"
                                            alt="img"
                                        />
                                    </div>
                                </div>
                ...
                {/* ================ Our Process Section =================== */}
                <section
                    id="our_application_process__section"
                    className="bg__blue"
                >
                    <div className="container">
                        <div className="section">
                                    ...
                                    <div className="col-md-6 offset-md-6 nopadding">
                                        <div className="mobile_app_process_child">
                                            <div
                                                data-aos="zoom-in"
                                                data-aos-delay="100"
                                                className="mobile_app_process_circle"
                                            >
                                            ...
                                            <div
                                                data-aos="fade-down"
                                                data-aos-delay="100"
                                                className="mobile_app_progress_bar"
                                            ></div>

                                            <div
                                                data-aos="fade-left"
                                                data-aos-delay="100"
                                                className="mobile_app_process_content"
                                            >
                                                <span className="green">
                                                    Research
                                                </span>
                                                <p className="text-white">
                                                    It is the fundamental stage
                                                    of our association. Apart
                                                    from understanding your
                                                    requirements, we try to
                                                    determine and streamline the
                                                    best features and
                                                    functionality of your app
                                                    that respond to human needs
                                                    and market expectations.
                                                    After hours of
                                                    risk-mitigation and market
                                                    analysis, we present you
                                                    with app ideas that can
                                    ...
                                    <div className="col-md-6 nopadding">
                                        <div className="mobile_app_process_child">
                                            <div
                                                data-aos="zoom-in"
                                                data-aos-delay="400"
                                                className="mobile_app_process_circle two"
                                            >
                                                <div className="mobile_app_process_circle_child"></div>
                                            </div>
                                            ...
                                            <div
                                                data-aos="fade-down"
                                                data-aos-delay="500"
                                                className="mobile_app_progress_bar two"
                                            ></div>

                                            <div
                                                data-aos="fade-right"
                                                data-aos-delay="400"
                                                className="mobile_app_process_content two"
                                            >
                                                <span className="green">
                                                    Designing
                                                </span>
                                                <p className="text-white">
                                                    ...
                                                    design of the mobile app is
                                                    just as important as its
                                                    features and functionality.
                                                    Hence, our team, working
                                                    closely with you, designs a
                                                    product that is not only up
                                                    to taste and expectations
                                                    but also unique, innovative,
                                                    and engaging from the user’s
                                                    point of view. And to
                                                    maintain transparency of our
                                                    work-in-progress, we share
                                                    regular updates in the form
                                                    of mockups and progress
                                                    reports for you to evaluate
                                    ...
                                    <div className="col-md-6 offset-md-6 nopadding">
                                        <div className="mobile_app_process_child">
                                            ...
                                            <div
                                                data-aos="fade-down"
                                                data-aos-delay="800"
                                                className="mobile_app_progress_bar three"
                                            ></div>
                                            ...
                                            >
                                                ...
                                                <p className="text-white">
                                                    ...
                                                    reformulating the way humans
                                                    and technology interact,
                                                    builds an app that brings a
                                                    competitive edge to your
                                                    business. We aim to give
                                                    shape to an app that not
                                                    only provides solutions to
                                                    users’ needs but also makes
                                                    headway to excellence,
                                                    thereby maximizing your
                                                    profits. And this is done
                                                    taking in various aspects
                                                    like sporadic connectivity,
                                                    variable bandwidth, device
                                                    form factor, UI/UX, and
                                    ...
                                    <div className="col-md-6 nopadding">
                                        <div className="mobile_app_process_child">
                                            ...
                                            >
                                                ...
                                                <p className="text-white">
                                                    At this final stage, after
                                                    rounds of trial and testing,
                                                    we stimulate the deployment
                                                    of the app on the Apple
                                                    Store and Google Play. Or,
                                                    if it’s an enterprise App,
                                                    we deploy it on your company
                                                    system for you to see
                                                    results. But wait! Now that
                                                    your app is up and running,
                                                    it doesn’t mean we are done
                                                    with our responsibilities.
                                                    We assist you with its
                                                    maintenance too. And if you
                                                    want an up-gradation, we can
                                                    start working on it within
                                                    24 hours.
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div className="portfolio_item row">
                                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 nopadding">
                                                    <div className="portfolio_item_img">
                                                        <img
                                                            src="/asset/mobile-app/mobile_njoys_portfolio.png"
                                                            alt="img"
                                                        />
                                                    </div>
                                                </div>
                                        ...
                                        <div className="item">
                                            <div className="portfolio_item row">
                                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 nopadding">
                                                    <div className="portfolio_item_img">
                                                        <img
                                                            src="/asset/mobile-app/mobile_fnb_portfolio.png"
                                                            alt="img"
                                                        />
                                                    </div>
                                                </div>
