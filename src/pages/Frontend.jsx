                            ...
                            <ul>
                                <li>
                                    <div className="ui__icon__container">
                                        <div className="ui__icon">
                                            <img
                                                src="/asset/frontend icons/1.png"
                                                alt="img"
                                            />
                                        </div>
                                ...
                                <li>
                                    <div className="ui__icon__container">
                                        <div className="ui__icon">
                                            <img
                                                src="/asset/frontend icons/2.png"
                                                alt="img"
                                            />
                                        </div>
                                ...
                                <li>
                                    <div className="ui__icon__container">
                                        <div className="ui__icon">
                                            <img
                                                src="/asset/frontend icons/3.png"
                                                alt="img"
                                            />
                                        </div>
                                ...
                                <li>
                                    <div className="ui__icon__container">
                                        <div className="ui__icon">
                                            <img
                                                src="/asset/frontend icons/4.png"
                                                alt="img"
                                            />
                                        </div>
                                ...
                                <li>
                                    <div className="ui__icon__container">
                                        <div className="ui__icon">
                                            <img
                                                src="/asset/frontend icons/5.png"
                                                alt="img"
                                            />
                                        </div>
                                ...
                                <li>
                                    <div className="ui__icon__container">
                                        <div className="ui__icon">
                                            <img
                                                src="/asset/frontend icons/6.png"
                                                alt="img"
                                            />
                                        </div>
                                ...
                                <li>
                                    <div className="ui__icon__container">
                                        <div className="ui__icon">
                                            <img
                                                src="/asset/frontend icons/7.png"
                                                alt="img"
                                            />
                                        </div>
                        ...
                        <div className="container">
                            <div className="section">
                                <div className="ecommerce__content">
                                    <h2>
                                        Want a pixel perfect, responsive
                                        frontend?
                                        <Link to="/services">We can help</Link>
                                    </h2>
                                    <p>
                                        We are a team of proficient and skillful
                                        web architects and software engineers.
                                        Based on advanced and latest industry
                                        trends, we aim to provide the most
                                        competent frontend development services,
                                        giving you the best value for your
                                        investment. Our innovative ideas,
                                        combined with the technical expertise in
                                        the field, ensure you get a product that
                                        compliments the user interface and user
                                        experience you are targeting for.{" "}
                                    </p>
                                    <ul>
                                        <li>
                    ...
                    <div className="section">
                        <div className="container">
                            <div className="frontend__container">
                                ...
                                <p>
                                    Every user has a different navigation
                                    pattern and browsing preferences. That’s why
                                    we rely on a frontend solution that is
                                    creative and pushes all the boundaries. We
                                    aim to cater to the user’s needs and demands
                                    with the same efficiency on all the devices.
                                    And we create a frontend that looks great,
                                    loads fast, and works without any glitches
                                    on all the screens. We develop interfaces
                                ...
                                <ul className="clearfix">
                                    <li className="progress_bar__1">
                                        <div
                                            data-aos="zoom-in"
                                            data-aos-delay="100"
                                            className="frontend_solution_circle"
                                        >
                                        ...
                                        <div
                                            data-aos="fade-right"
                                            data-aos-delay="100"
                                            className="frontend_bar__progress_one"
                                        ></div>
                                        <div
                                            data-aos="fade-up"
                                            data-aos-delay="100"
                                            className="frontend_solution__text"
                                        >
                                            <label>Fast</label>
                                            <p>
                                                To speed up user interactivity
                                    ...
                                    <li className="progress_bar__2">
                                        ...
                                        <div
                                            data-aos="fade-right"
                                            data-aos-delay="400"
                                            className="frontend_bar__progress_two"
                                        ></div>
                                        <div
                                            data-aos="fade-up"
                                            data-aos-delay="400"
                                        ...
                                        >
                                            ...
                                            <p>
                                                To meet up your expectations and
                                                industry standards
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li className="progress_bar__3">
                                        ...
                                        <div
                                            data-aos="fade-right"
                                            data-aos-delay="700"
                                            className="frontend_bar__progress_three"
                                        ></div>
                                        <div
                                            data-aos="fade-up"
                                            data-aos-delay="700"
                        ...
                        <div className="hosted_ecommerce row">
                            <div className="col-xl-6 col-lg-6 col-md-6 nopadding mobile__visible">
                                <div className="hosted_ecommerce_right">
                                    <img
                                        src="/asset/psd-to-html-img.png"
                                        alt="Psd To HTML Image"
                                        title="Psd To HTML Image"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                                <div className="hosted_ecommerce_left">
                                    <h2 className="text-white">
                                        PSD to HTML Solutions
                                    </h2>
                                    <p className="text-white">
                                        From designing your website on Photoshop
                                        and Figma to converting it to code using
                                        HTML, we ace at everything. We take
                                        pride in providing customized solutions
                                        for your business challenges, using the
                                        latest industrial trends and
                                        technologies. We weave our industrial
                                        expertise and technological innovation
                                        to transform PSD files into responsive
                                        and high-performing website pages.
                                    </p>
                                    <ul className="text-white">
                                        <li>
                                            Fully responsive HTML that is
                                            compliant with all the devices.{" "}
                                        </li>
                                        <li>
                                            Hand-coded and pixel perfect
                                            HTML/CSS as per the design file.
                                        </li>
                                        <li>
                                            Semantic code tested and compliant
                                            with all the browsers.
                                        </li>
                                        <li>
                                            jQuery animations - sliders,
                                            tooltips, and more.
                                        </li>
                                        <li>
                                            Custom fonts to bring a unique look
                                            to your website.
                                        </li>
                                        <li>
                                            W3C validated code which means a
                                            clean and bug-free website.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                                <div className="portfolio__item__text">
                                                    ...
                                                    <p>
                                                        This brand needs no
                                                        introduction.
                                                        Nevertheless, Karbonn
                                                        Mobiles is one of the
                                                        frontliners of the
                                        ...
                                        <div className="portfolio__item row">
                                            ...
                                            <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                                <div className="portfolio__item__text">
                                                    <h5>Anges Bags</h5>
                                                    <p>
                                                        With an experience of 80
                                                        years in marketing and
                                                        manufacturing, Anges
                                                        Bags is one of the
                                                        leading manufacturer and
                                                        exporters of jute bags.
                                                    </p>
                                                    <span>UI/UX</span>
                                                    <span>
                                                        FrontEnd Development
                                            ...
                                            <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                                <div className="portfolio__item__text">
                                                    ...
                                                    <p>
                                                        ...
                                                        with offices in 10
                                                        countries. They have 10+
                                                        years of experience in
                                                        selling, implementing,
                                                        supporting, and
                                                        operating Source-to-Pay
                                                        solutions.
                                                    </p>
                                                    <span>UI/UX</span>
                                                    <span>
