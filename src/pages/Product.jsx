                    ...
                    <div className="container clearfix">
                        <div className="ui__banner">
                            ...
                            <h1 className="text-white">
                                <span className="green">Got an idea?</span>{" "}
            ...
            <div id="main__content">
                    ...
                    <div className="container">
                        <div className="section">
                            <div className="ecommerce_solution_content">
                                <h2>
                                    Want to build a scalable web and mobile
                                    platform? <br />
                                    <Link to="/contact">We can help</Link>
                                </h2>
                                <p>
                                    At United Monks, we design, engineer, and
                                    develop scalable products for entrepreneurs,
                                    inventors, startups, and businesses alike.
                                    From conceptualization to realization, our
                                    team of experienced fullstack developers,
                                    UI/UX designers, QAs and DevOps engineer
                                    does it all. Masters of our craft, we create
                                    products that look good, work even better,
                                    and make an impact on the market, all while
                                    sticking to the client requirements. We
                                    don’t just propose innovative ideas and
                                    concepts, we see them through and make them
                                    work.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container" id="what_we_offer__section">
                    <div className="web_app_offer">
                        ...
                        <p>
                            As an experienced team of engineers, we address all
                            your product requirements with the best
                            technologies. After analyzing all the specifics of
                            your platform, we propose a combination of tools and
                            methodology that is business-effective while
                            tackling your industrial challenges at the same
                            time.
                        </p>
                        <div className="web_app_offer_child row">
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 nopadding">
                                <div className="what_we_offer_child_content">
                                    <img
                                        src="/asset/what we offer icons/1.png"
                                        alt="img"
                                    />
                                    <span>
                                        Node.js <br />
                                    ...
                                    <p>
                                        We build Node.js based web applications
                                        that are stable, powerful, and
                                        profitable. In short, they meet with,
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 nopadding">
                                <div className="what_we_offer_child_content">
                                    <img
                                        src="/asset/what we offer icons/2.png"
                                        alt="img"
                                    />
                                    <span>
                                        Laravel <br />
                                    ...
                                    <p>
                                        While laravel based websites are known
                                        to be plain and simple, we add the
                                        beauty and elegance that will blow your
                                        mind.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 nopadding">
                                <div className="what_we_offer_child_content">
                                    <img
                                        src="/asset/what we offer icons/3.png"
                                        alt="img"
                                    />
                                    <span>
                                        CMS Based <br />
                                    ...
                                    <p>
                                        With customized CMS based applications,
                                        we ensure that you are in control of
                                        creation, modification, or removal of
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 nopadding">
                                <div className="what_we_offer_child_content">
                                    <img
                                        src="/asset/what we offer icons/4.png"
                                        alt="img"
                                    />
                                    <span>
                                        Wordpress <br />
                                    ...
                                    <p>
                                        Stay ahead of your competitor while
                                        staying current with market trends with
                                        our cost-effective and customisable
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 nopadding">
                                <div className="what_we_offer_child_content">
                                    <img
                                        src="/asset/what we offer icons/5.png"
                                        alt="img"
                                    />
                                    <span>
                                        API <br />
                                    ...
                                    <p>
                                        For a complete API development
                                        environment, from voice and video to
                                        payment and cloud and more, we got you
                                        covered.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 nopadding">
                                <div className="what_we_offer_child_content">
                                    <img
                                        src="/asset/what we offer icons/6.png"
                                        alt="img"
                                    />
                                    <span>
                                        Web <br />
                                    ...
                                    <p>
                                        Under controlled experimentation, we
                                        thrive to improve your web
                                        application&apos;s ability to drive
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 nopadding">
                                <div className="what_we_offer_child_content">
                                    <img
                                        src="/asset/what we offer icons/7.png"
                                        alt="img"
                                    />
                                    <span>
                                        ECommerce <br />
                                    ...
                                    <p>
                                        We build easy-to-navigate and scalable
                                        e-commerce applications so that you
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 nopadding">
                                <div className="what_we_offer_child_content">
                                    <img
                                        src="/asset/what we offer icons/8.png"
                                        alt="img"
                                    />
                                    <span>
                                        Fixing Bugs <br />
                                    ...
                                    <p>
                                        Our team of experts manages support
                                        services so that your operating system
                                        keeps on going fail-safe and bug-free.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <section id="our__values__section" className="bg__blue">
                    <div className="container">
                        <h2 className="green">
                            Why you need our dedicated team of web developers
                        </h2>
                        ...
                        <div className="values__point row">
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 nopadding">
                                <div className="value__unit">
                                    ...
                                    <span className="text-white">
                                        ...
                                        confidentiality you would like to
                                        maintain.
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4 col-lg-offset-4 col-md-offset-4 col-sm-offset-4 col-lg-4 col-md-4 col-sm-4 nopadding"></div>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 nopadding">
                                <div className="value__unit">
                                    ...
                                    <span className="text-white">
                                        Because you trust us, installation and
                                        set-up cost is on the house.
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 nopadding">
                                <div className="value__unit">
                                    ...
                                    <span className="text-white">
                                        We promote your website leveraging
                                        techniques like SEO and Google listing.
                                    </span>
                                </div>
                            </div>
                        </div>
