                    ...
                    <div className="container clearfix">
                        <div className="ui__banner">
                            ...
                            <h1 className="text-white">
                                <span className="green">For graphics that</span>{" "}
                    ...
                    <div className="container">
                        <div className="section">
                            <div className="ecommerce_solution_content">
                                <h2>
                                    Looking for designs that champion creativity
                                    and utility?
                                    <Link to="/services">We can help?</Link>
                                </h2>
                                <p>
                                    United monks specialize in taking your ideas
                                    and bringing them to life! How? We meditate
                                    on it. Ha-ha-ha, just kidding! We brainstorm
                                    ideas, come up with concepts, burn the
                                    midnight oil, drink copious amounts of
                                    caffeine, and then we do it all over again
                                    till we hit that sweet spot otherwise known
                                    as perfection. At United Monks, we craft
                                    designs that tell your story the way you’d
                                    like it to be told.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="hire_us_child row">
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 nopadding">
                                        <div className="hire_us_child_content first_child">
                                            <a
                                                href="#"
                                                className="hire_us_child_parent"
                                            >
                                                <img
                                                    src="/asset/graphic/logo-and-branding.png"
                                                    alt="img"
                                                />
                                                <span>
                                                    Logo &amp; Brand <br />
                                                ...
                                                <p>
                                                    A logo reflects the value of
                                                    your brand. And we make it
                                                    look polished, distinctive
                                                    and memorable.
                                                </p>
                                            </a>
                                        </div>
                                        ...
                                        <div className="hire_us_child_content border_top_none border-left">
                                            ...
                                            >
                                                ...
                                                <p>
                                                    ...
                                                    collaterals that are
                                                    creative, impactful, and
                                                    memorable? Your quest ends
                                                    here!
                                                </p>
                                            </a>
                                        </div>
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 nopadding">
                                        <div className="hire_us_child_content first_child border_bottom">
                                            ...
                                            >
                                                <img
                                                    src="/asset/graphic/infographics.png"
                                                    alt="img"
                                                />
                                                <span>
                                                    Infographics &amp; <br />
                                                ...
                                                <p>
                                                    Our infographics give shape
                                                    to words while our
                                                    illustrations bring even the
                                                    most mundane visuals to
                                                    life.
                                                </p>
                                            </a>
                                        </div>
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 nopadding">
                                        <div className="hire_us_child_content border-left border_bottom border_top_none">
                                            ...
                                            >
                                                ...
                                                <p>
                                                    We enhance your brand’s
                                                    visibility with out of the
                                                    box designs to support your
                                                    marketing strategy.
                                                </p>
                                            </a>
                                        </div>
                                    ...
                                    >
                                        <div className="item">
                                            <div className="hire_us_carousel_item">
                                                <img
                                                    src="/asset/graphic/brand_identity.png"
                                                    alt="img"
                                                />
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="hire_us_carousel_item">
                                                <img
                                                    src="/asset/graphic/packaging.png"
                                                    alt="img"
                                                />
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="hire_us_carousel_item">
                                                <img
                                                    src="/asset/graphic/brochure.png"
                                                    alt="img"
                                                />
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="hire_us_carousel_item">
                                                <img
                                                    src="/asset/graphic/tshirt_designing.png"
                                                    alt="img"
                                                />
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="hire_us_carousel_item">
                                                <img
                                                    src="/asset/graphic/menu_designing.png"
                                                    alt="img"
                                                />
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="hire_us_carousel_item">
                                                <img
                                                    src="/asset/graphic/billboard_design.png"
                                                    alt="img"
                                                />
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="hire_us_carousel_item">
                                                <img
                                                    src="/asset/graphic/standee_design.png"
                                                    alt="img"
                                                />
                                            </div>
                                        </div>
                    ...
                    <div className="hire_us_bottom row">
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 nopadding">
                            <div className="hire_us_child_content first_child border_bottom">
                                <a href="#" className="hire_us_child_parent">
                                    <img
                                        src="/asset/graphic/resturant-menu.png"
                                        alt="img"
                                    />
                                    <span>
                                        Restaurant <br />
                                    ...
                                    <p>
                                        For mouthwatering menus with tasty
                                        descriptions, crisp fonts, and design
                                        panache, give us a call
                                    </p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 nopadding">
                            <div className="hire_us_child_content first_child second_child">
                                <a href="#" className="hire_us_child_parent">
                                    <img
                                        src="/asset/graphic/packaging-icon.png"
                                        alt="img"
                                    />
                                    <span>
                                        Packaging <br />
                                    ...
                                    <p>
                                        Packaging design so fine, your customers
                                        are going to fall over themselves
                                        ordering for your products.
                                    </p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 nopadding">
                            <div className="hire_us_child_content first_child third_child">
                                <a href="#" className="hire_us_child_parent">
                                    ...
                                    <p>
                                        Fancy some customized T-shirt designs?
                                        We got you!
                                    </p>
                                </a>
                            </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 nopadding">
                            <div className="hire_us_child_content first_child border_right fourth_child">
                                <a href="#" className="hire_us_child_parent">
                                    <img
                                        src="/asset/graphic/social-media-banner.png"
                                        alt="img"
                                    />
                                    <span>
                                        Social Media <br />
                                    ...
                                    <p>
                                        Banners are what captures your audience
                                        hook, line and sinker, so say yay to
                                        captivating banners with us!
                                    </p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 nopadding">
                            <div className="hire_us_child_content first_child fifth_child border_bottom">
                                <a href="#" className="hire_us_child_parent">
                                    <img
                                        src="/asset/graphic/email-newsletter.png"
                                        alt="img"
                                    />
                                    <span>
                                        Email <br />
                                    ...
                                    <p>
                                        Live that high click rate life with
                                        persuasive and creative newsletters that
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 nopadding">
                            <div className="hire_us_child_content first_child sixth_child border_top_none border_bottom">
                                <a href="#" className="hire_us_child_parent">
                                    <img
                                        src="/asset/graphic/powerpoint-presentation.png"
                                        alt="img"
                                    />
                                    <span>
                                        PowerPoint <br />
                                    ...
                                    <p>
                                        Well structured, well-designed and
                                        absorbing in every way possible, your
                                        presentation will grab everyone’s
                                        attention in no time at all.
                                    </p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 nopadding">
                            <div className="hire_us_child_content first_child seven_child border_top_none border_bottom">
                                <a href="#" className="hire_us_child_parent">
                                    <img
                                        src="/asset/graphic/word-template.png"
                                        alt="img"
                                    />
                                    <span>
                                        Word <br />
                                    ...
                                    <p>
                                        With templates so tasteful, even the
                                        humble MS Word will become a captivating
                                        ally in your work planning.
                                    </p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 nopadding">
                            <div className="hire_us_child_content last_child first_child border_top_none border_right border_bottom">
                                <a href="#" className="hire_us_child_parent">
                                    <img
                                        src="/asset/graphic/website-banner.png"
                                        alt="img"
                                    />
                                    <span>
                                        Website <br />
                                    ...
                                    <p>
                                        Is your dream banner made of all things
                                        eye-catching and traffic generating?
                                        Let’s talk!
                                    </p>
                                </a>
                            </div>
