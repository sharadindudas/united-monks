                    ...
                    <div className="container clearfix">
                        <div className="ui__banner">
                            ...
                            <h1 className="text-white">
                                <span className="green">Get engaging</span>{" "}
                    ...
                    <div className="container">
                        <div className="section">
                            <div className="ecommerce_solution_content">
                                <h2>
                                    Time to ditch boring presentations and win
                                    clients.
                                    <Link to="/services">We can help?</Link>
                                </h2>
                                <p>
                                    Our agency doesn’t do boring and we don’t
                                    believe in off-the-shelf PowerPoint
                                    templates. Our aim is to not just design but
                                    also tell stories via slide decks. From
                                    writing content to developing graphics, we
                                    create bespoke presentations that narrate
                                    your tales in the most engaging ways
                                    possible. Our presentations fit you, your
                                    brand, your audience, and your brand
                                    communication in every way possible.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="presentation_services row">
                            <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                                <div className="presentation_services_left">
                                    ...
                                    <p>
                                        With deep understanding and years of
                                        experience of design and digital
                                        storytelling and communication, our team
                                        delivers presentations that are crafted
                                        to match your expectations. Our
                                        multi-dimensional expertise and dynamic
                                        work portfolio have given us the upper
                                        hand to create tailormade presentation
                                        designs that suit diversified use cases
                                        and scenarios.
                                    </p>
                                    <div className="presentation_services_child row">
                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 nopadding">
                                            <div className="services_child_element odd">
                                                ...
                                                <p>
                                                    From pitch deck and client
                                                    proposals to investor
                                                    updates and company
                                                    profiles, we ace every
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 nopadding">
                                            <div className="services_child_element even">
                                                ...
                                                <p>
                                                    From marketing proposals to
                                                    monthly metric reports, our
                                                    expertise covers all the key
                                                    elements of PR
                                                    presentations.
                                                </p>
                                            </div>
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 nopadding">
                                            <div className="services_child_element odd">
                                                ...
                                                <p>
                                                    ...
                                                    you not only initiate a deal
                                                    on a positive note but also
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 nopadding">
                                            <div className="services_child_element even">
                                                ...
                                                <p>
                                                    ...
                                                    handling a college
                                                    assignment or a professor
                                                    turning in a thesis, we’ve
                                                    got you covered.{" "}
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                                <div className="presentation_services_carousel">
                                    ...
                                    >
                                        <div className="item">
                                            <img
                                                src="/asset/powerpoint/presentation-carousel-img1.png"
                                                alt="img"
                                            />
                                        </div>
                                        <div className="item">
                                            <img
                                                src="/asset/powerpoint/presentation-carousel-img2.png"
                                                alt="img"
                                            />
                                        </div>
                                        <div className="item">
                                            <img
                                                src="/asset/powerpoint/presentation-carousel-img3.png"
                                                alt="img"
                                            />
                                        </div>
                                        <div className="item">
                                            <img
                                                src="/asset/powerpoint/presentation-carousel-img4.png"
                                                alt="img"
                                            />
                                        </div>
                                    </OwlCarousel>
                        ...
                        <div className="col-xl-6 col-lg-12 col-md-12 nopadding">
                            <div className="presentation_services_left">
                                ...
                                <p>
                                    ...
                                    experience of design and digital
                                    storytelling and communication, our team
                                    delivers presentations that are crafted to
                                    match your expectations. Our
                                    multi-dimensional expertise and dynamic work
                                    portfolio have given us the upper hand to
                                    create tailormade presentation designs that
                                    suit diversified use cases and scenarios.
                                </p>
                                ...
                                <div className="presentation_services_child row">
                                    <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                                        <div className="services_child_element odd">
                                            ...
                                            <p>
                                                From pitch deck and client
                                                proposals to investor updates
                                                and company profiles, we ace
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                                        <div className="services_child_element odd">
                                            ...
                                            <p>
                                                With our sales presentation, you
                                                not only initiate a deal on a
                                                positive note but also close it
                                                successfully.{" "}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 nopadding">
                                        <div className="services_child_element even">
                                            ...
                                            <p>
                                                Whether you are a student
                                                handling a college assignment or
                                                a professor turning in a thesis,
                        ...
                        <div className="section">
                            <div className="presentation_process_content">
                                ...
                                <p className="text-white">
                                    The value and importance of eye-catching
                                    PowerPoint presentations has permeated into
                                    every sphere of marketing and communication.
                                    Hence, with our professionally designed and
                                    innovative presentations, we aim to set your
                                    brand apart.
                                </p>
                                <div className="presentation_process_child row">
                                    <div className="col-xl-4 col-lg-4 col-md-4 nopadding">
                                        <div className="presentation_child_content">
                                            ...
                                            <p className="text-white">
                                                ...
                                                your company, our initial
                                                research revolves around you and
                                                your business. Once we have
                                                everything we need, we
                                                conceptualize and present you
                                                with ideas that cover everything
                                                from plain and simple to
                                                on-the-face and daring.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-xl-4 col-lg-4 col-md-4 nopadding">
                                        <div className="presentation_child_content">
                                            ...
                                            <p className="text-white">
                                                That’s a lot that’s possible
                                                with a PPT presentation. After
                                                analyzing your preferences and
                                                the type of content you want, we
                                                can take your presentation to
                                                the next level. We can also
                                                customize graphics,
                                                illustrations, and animations to
                                                present your content in a more
                                                engaging manner.{" "}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-xl-4 col-lg-4 col-md-4 nopadding">
                                        <div className="presentation_child_content">
                                            ...
                                            <p className="text-white">
                                                ...
                                                here we plan how to create a
                                                fusion of storytelling and
                                                design that’s crisp, easy to
                                                follow, and fun to listen for
                                                you and others. We plan an
                                                appropriate color scheme and
                                                graphics so that you have an
                                                immersive visual journey to
                                                present.
                                            </p>
                                        </div>
                                    </div>
