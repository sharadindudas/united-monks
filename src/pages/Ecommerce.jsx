        ...
        <div className="ecommerce__wrapper overflow">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div className="ui__icon__container">
                                        <div className="ui__icon">
                                            <img
                                                src="/asset/ecommerce/shopify.png"
                                                alt="img"
                                            />
                                        </div>
                                ...
                                <li>
                                    <div className="ui__icon__container">
                                        <div className="ui__icon">
                                            <img
                                                src="/asset/ecommerce/prestashop.png"
                                                alt="img"
                                            />
                                        </div>
            ...
            <div id="main__content">
                        ...
                        <div className="container">
                            <div className="section">
                                <div className="ecommerce__content">
                                    ...
                                    <p>
                                        Who doesn’t want to own an
                                        income-generating, sales-making
                                        business? We can make this a reality for
                                        your E-commerce projects.
                                        <br />
                                        To get the best value on your
                                        investment, choose from our vast range
                                        of E-commerce packages, software and
                                        shopping cart systems. After that, our
                                        experts will pour their blood, sweat,
                                        and tears into designing and developing
                                        a website that’ll make you Richie Rich.
                                        But our commitment doesn’t end there.
                                        With tight competition in the online
                                        marketplace, you might need a little
                                        help, and that’s exactly what we’ll
                                        provide. We’ll continue giving you the
                                        support and the maintenance you need to
                                        hold your own and become the best
                                        E-commerce site there is.
                                    </p>
                                    <ul>
                                        <li>
                ...
                <div className="container-fluid">
                    <div
                        className="hosted_ecommerce row"
                        id="hosted_ecommerce__section"
                    >
                        <div className="col-xl-6 col-lg-6 col-md-6 nopadding mobile__visible">
                            <div className="hosted_ecommerce_right">
                                <img
                                    src="/asset/ecommerce/hosted-ecommerce-img.png"
                                    alt="img"
                                />
                            </div>
                        </div>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                            <div className="hosted_ecommerce_left">
                                ...
                                <p>
                                    Heard of Software as a Service (SaaS)? In
                                    case you’re a newbie and this jargon is all
                                    Greek to you, let us put it simply: This is
                                    the solution to all your questions. With
                                    this option, you get the whole online
                                    shopping cart system, a preconfigured
                                    integrated product catalogue tool for easy
                                    implementation and a customized website that
                                    is dripping with your brand identity.
                                </p>
                                <span>
                                    What all do you choose from? It’s yours for
                                    the picking:
                                </span>
                                <ul>
                                    <li>Shopping Cart</li>
                ...
                <div className="container-fluid">
                    <div
                        className="advance_ecommerce row"
                        id="advance_ecommerce__section"
                    >
                        <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                            <div className="advance_ecommerce_left">
                                <img
                                    src="/asset/ecommerce/advanced-ecommerce-img.png"
                                    alt="img"
                                />
                            </div>
                        </div>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                            <div className="advance_ecommerce_right">
                                ...
                                <div className="hosted_ecommerce_left">
                                    ...
                                    <p>
                                        Want to get everything without making a
                                        compromise? Well, this is just for you.
                                        With advanced E-commerce solutions, your
                                        potential online revenue grows higher
                                        and you won’t have to sacrifice
                                        anything. It’s because our customized
                                        solutions will integrate and fit right
                                        in with your existing product database
                                        and enterprise system.
                                    </p>
                                    <span>
                                        Along with the features with a hosted
                                        solution, you also get:
                                    </span>
                                    <ul>
                                        ...
                                        <li>
                                            Scalability with full feature
                                            capacity
                                        </li>
                                        <li>
                                            If you need something that isn’t on
                                            the above list, just ask. We’re
                                            happy to provide precisely what
                                            works best for you
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="values_point row">
                                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 nopadding">
                                    <div className="our_value_unit">
                                        ...
                                        <span>
                                            Be it desktops, tablets or mobile
                                            devices, we’ll make your E-commerce
                                            website responsive on every device,
                                            making you more visible. And greater
                                            the visibility for your business,
                                            the wider its reach, and more your
                                            profit.
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 nopadding">
                                    <div className="our_value_unit">
                                        ...
                                        <span>
                                            The most annoying thing when
                                            visiting an E-commerce website is
                                            the loading time. And that’s what
                                            our developers avoid with tried and
                                            tested methods coupled with the
                                            latest techniques. We make your
                                            user’s shopping experience lightning
                                            fast, taking them from browsing to
                                            check out in just seconds.
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 nopadding">
                                    <div className="our_value_unit">
                                        ...
                                        <span>
                                            It doesn’t matter what your products
                                            are, we provide you a host of
                                            options for all of them. From
                                            customizing your product options
                                            based on your requirements to
                                            providing a completely new set of
                                            product features and functionality,
                                            there’s plenty that you can do with
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 nopadding">
                                    <div className="our_value_unit">
                                        ...
                                        <span>
                                            No more fuss when it comes to
                                            updating pages, categories, products
                                            and other content on your website.
                                            We will design a content management
                                            system so easy, anyone will be able
                                            to breeze through it like a pro.
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 nopadding">
                                    <div className="our_value_unit">
                                        ...
                                        <span>
                                            When running an E-commerce website,
                                            marketing is vital. We will help you
                                            boost your marketing abilities with
                                            tools that help optimize your page
                                            for search engines, create landing
                                            pages, and run promotions to drive
                                            revenue.
                                        </span>
                                    </div>
                                </div>
                                        ...
                                        <div className="portfolio__item row">
                                            ...
                                            <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                                <div className="portfolio__item__text">
                                                    ...
                                                    <a
                                                        href="https://www.njoyskratom.com/"
                                                        target="_blank"
                                                        rel="noreferrer"
                                                    >
                                                        Visit Website
                                        ...
                                        <div className="portfolio__item row">
                                            ...
                                            <div className="col-xl-4 col-lg-4 col-md-5 col-sm-12 nopadding">
                                                <div className="portfolio__item__text">
                                                    <h5>Farm in Box</h5>
                                                    <p>
                                                        Farm in Box is one of
                                                        the leading and
                                                        most-trusted Hydroponic
                                                        farms in the Delhi-NCR.
                                                    </p>
                                                    <span>E-commerce</span>
                                                    <span>UI/UX</span>
                                                    <span>Branding</span>
