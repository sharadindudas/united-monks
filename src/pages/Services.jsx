...
function Services() {
    ...
    useEffect(() => {
        document.title =
            "Cloud Management, Web Development, Mobile App & Product Development Service";
        ...
        <div className="services__wrapper clearfix">
            ...
            <header className="header__section">
                ...
                <ul className="header__ul">
                    ...
                    <li>
                        <Link to="/services" className="header__link active">
                            services
                        </Link>
                    </li>
                    <li>
                        ...
                        <div className="slider__text__container">
                            <h1>
                                ...
                                <span className="mobile__visible">
                                    Each Service is a quest for perfection, And
                                    we deliver every single time
                                    <span className="green">.</span>
                                </span>
                            </h1>
                            <div className="banner__caption">
                                United we stand to ensure that our services will
                                never have you in two minds. Flexible in our
                                processes, we identify your needs and use them
                                as our guiding force to exceed your expectations
                                    ...
                                    <div className="portfolio__section">
                                        <article className="portfolio__item pf__one">
                                            <div className="portfolio__item__container">
                                                ...
                                                <h4>UI/UX</h4>
                                                <p>
                                                    With 5+ years of application
                                                    design experience, United
                                                    Monks is your best choice
                                                    for UI/UX services. We make
                                                    your ideas and applications
                                                    stand out with intelligently
                                                    crafted intuitive designs.
                                                    Everything from the
                                                    wireframes to prototypes is
                                                    a reflection of our core
                                                    strengths - exceptional user
                                                    experiences and perfection
                                                    in user flow.
                                                </p>
                                                <ul>
                                                    <li>UI/UX Audit</li>
                                        ...
                                        <article className="portfolio__item pf__two">
                                            <div className="portfolio__item__container pf__item2__container">
                                                ...
                                                <p>
                                                    Our skilled team of
                                                    front-end developers creates
                                                    software that looks
                                                    impressive on all screen
                                                    sizes. We create glitch free
                                                    interfaces that also load
                                                    fast. We offer front-end
                                                    architecture and design
                                                    services using cutting-edge
                                                    technologies to give a
                                                    smooth, fast, and intuitive
                                                    navigation.
                                                </p>
                                                <ul>
                                                    <li>
                                        ...
                                        <article className="portfolio__item pf__three">
                                            <div className="portfolio__item__container">
                                                ...
                                                <p>
                                                    Every app is an amalgamation
                                                    of multiple technologies
                                                    that are closely woven
                                                    together. We offer
                                                    customised and secure web
                                                    application development
                                                    solutions and have an expert
                                                    team taking care of
                                                    everything, whether
                                                    it&apos;s Laravel for
                                                    larger, more complex
                                                    projects, or WordPress for
                                        ...
                                        <article className="portfolio__item pf__four">
                                            <div className="portfolio__item__container">
                                                ...
                                                <p>
                                                    ...
                                                    aren’t built in a day, and
                                                    for good reason. We put
                                                    together powerful
                                                    architecture, unique
                                                    features and appropriate
                                                    technology while
                                                    understanding cost
                                                    ...
                                                    support to roll out a
                                                    jaw-dropping final product.
                                                </p>
                                                <ul>
                                                    <li>
                                        ...
                                        <article className="portfolio__item pf__five">
                                            <div className="portfolio__item__container">
                                                ...
                                                <p>
                                                    ...
                                                    business online you’ve come
                                                    to the right place. We offer
                                                    customized eCommerce
                                                    solutions that have the best
                                                    features and functionality.
                                                    From advanced search engines
                                                    to optimization tools and
                                                    from fast browsing to easy
                                                    checkout, we create portals
                                                    that will meet your business
                                                    goals and help your revenue
                                                    shoot up.
                                                </p>
                                                <ul>
                                                    <li>
                                        ...
                                        <article className="portfolio__item pf__seven">
                                            <div className="portfolio__item__container">
                                                ...
                                                <p>
                                                    From web banners and landing
                                                    pages to ad designs and
                                                    more, tell us what you need
                                                    in a comprehensive brief and
                                                    we will offer custom designs
                                                    that match your
                                                    requirements. We factor in
                                                    business initiative and
                                                    trends to improve our
                                                    designs to transform your
                                                    ideas into reality using
                                                    refined design software and
                                        ...
                                        <article className="portfolio__item pf__eight">
                                            <div className="portfolio__item__container">
                                                ...
                                                <p>
                                                    ...
                                                    developing graphics, we
                                                    create bespoke presentations
                                                    that narrate your tales in
                                                    the most engaging ways
                                                    possible. Our presentations
                                                    fit you, your brand, your
                                        ...
                                        <article className="portfolio__item pf__nine">
                                            <div className="portfolio__item__container">
                                                ...
                                                <p>
                                                    ...
                                                    intruders by choosing a
                                                    full-stack cyber security
                                                    scan. Our experts will
