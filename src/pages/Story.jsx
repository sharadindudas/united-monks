        ...
        <div className="wrapper overflow">
            ...
            <header className="header__section">
                ...
                <ul className="header__ul">
                    ...
                    <li>
                        <Link to="/story" className="header__link active">
                            our story
                        </Link>
                    </li>
                    <li>
                ...
                <div className="slider__container">
                    ...
                    <div className="container clearfix">
                        <div className="slider__story slider__text__container">
                            ...
                            <div className="banner__story banner__caption">
                                Simplicity is the mark of a true genius, and of
                                new age digital monks (Meaning us!). Anybody can
                                find complex solutions to complex problems. But
                                it takes exceptional skill to look for the
                                perfection that lies in simplicity. And that’s
                                what our developers, designers, and strategists
                                love to do.{" "}
                            </div>
                        </div>
                    </div>
                ...
                <div className="content__wrapper nopadding">
                    ...
                    <section id="how__it__started__section">
                        <div className="container">
                            <h2>
                                ...
                                Milestone
                                <br />
                                To Another<span className="green">.</span>
                            </h2>
                            <div data-aos="fade-up" data-aos-duration="2000">
                                <p>
                                    United Monks was established by a group of
                                    people driven by a strong desire to explore
                                    the full potential of their talent. We left
                                    behind office politics, 12-hour work days,
                                    crappy coffee and everything bad, ugly, and
                                    ugliest to pursue creativity without drama.
                                    And that’s how, 6 years ago, we began our
                                    journey to greatness and beyond.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="our__values__section" className="bg__blue">
                        <div className="container">
                            ...
                            <p className="text-white desktop__visible">
                                If there’s one thing United Monks runs on, it’s
                                values. They are our Holy Grail, our Book of
                                God, <br />
                                and the only constant in a world of change.{" "}
                            </p>
                            <p className="text-white mobile__visible">
                                If there’s one thing United Monks runs on, it’s
                                values. They are our Holy Grail, our Book of
                                God, and the only constant in a world of change.{" "}
                            </p>
                            ...
                            <div className="how__we__work__container row">
                                <div className="col-xl-7 col-lg-7 col-md-7 nopadding">
                                    <div className="how__we__work__left">
                                        ...
                                        <p>
                                            Achieving perfection isn’t easy, but
                                            we’ve managed to create a process
                                            that works like a charm every single
                                            time.{" "}
                                        </p>
                                        ...
                                        <Link to="/services">
                                            <button className="desktop__visible bg__green">
                                                Know More
                                            </button>
                                        </Link>

                                        <Link to="/services">
                                            <button className="tab__visible bg__green">
                                                Know More
                                            </button>
                                        </Link>
                                    </div>
                                ...
                                <div className="col-xl-1 col-lg-1 col-md-1 nopadding">
                                    <div className="how__we__work__img">
                                        <img
                                            src="/asset/vertical-line.png"
                                            alt="Unitedmonks Vertical Line"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-4 nopadding">
                                    <div className="how__we__work__right">
                                        ...
                                        <Link to="/services">
                                            <button className="mobile__visible bg__green">
                                                Know More
                                            </button>
                                        </Link>
                                    </div>
