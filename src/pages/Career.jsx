...
function Career() {
    ...
    useEffect(() => {
        document.title =
            "Career | Always Happy To Meet New Talents - United Monks";
                ...
                <div className="slider__career slider__container">
                    ...
                    <div className="container clearfix">
                        <div className="slider__career slider__text__container">
                            <h1>
                                Dear rule-breakers, curious backbenchers &amp;
                                straight-A students - <br />
                                We want you all<span className="green">.</span>
                            </h1>

                            <div className="banner__career banner__caption">
                                We’re hiring people who share our values and
                                passion. You might be just starting out or have
                                years of experience—either way, we’d like to
                                hear from you and see the projects you’re proud
                                of.
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="career__form__container">
                                ...
                                >
                                    ...
                                    <div className="career__description">
                                        <h5>
                                            Last few months what kept you busy?
                                        </h5>
                                        <textarea
                                            onChange={(e) =>
