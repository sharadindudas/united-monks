    ...
    <div className="wrapper overflow">
      ...
      <header className="header__section">
        ...
        <ul className="header__ul">
          ...
          <li>
            <Link to="/career" className="header__link active">
              career
            </Link>
          </li>
          <li>
        ...
        <div className="slider__career slider__container">
          ...
          <div className="container clearfix">
            <div className="slider__career slider__text__container">
              <h1>
                Dear rule-breakers, curious backbenchers &amp; straight-A
                students - <br />
                We want you all<span className="green">.</span>
              </h1>

              <div className="banner__career banner__caption">
                We’re hiring people who share our values and passion. You might
                be just starting out or have years of experience—either way,
                we’d like to hear from you and see the projects you’re proud of.
              </div>
            </div>
          </div>
                ...
                <form ref={form} id="career__form" onSubmit={sendEmail}>
                    ...
                    <div className="last__form__group form__group">
                      <div className="custom__file__input">
                        <input
                          onChange={handleFile}
                          type="file"
                          className="file__input text__input"
                          ...
                          <div className="career__checkbox__parent">
                            <div className="career__checkbox__child">
                              <input
                                ...
                                className="checkbox"
                                type="checkbox"
                                onChange={(e) => getCheckVal(e)}
                                name="designer"
                                value="UI/UX Designer"
                              />
                              <label htmlFor="checkbox18" className="label">
                                UI/UX Designer
                              </label>
                            </div>
                          </div>
                          ...
                          <div className="career__textbox__parent">
                            <div className="career__checkbox__child">
                              <input
                                ...
                                className="checkbox"
                              />
                              <label htmlFor="checkbox20" className="label">
                                Graphics Designer
                              </label>
                            </div>
                          </div>
                          ...
                          <div className="career__textbox__parent">
                            <div className="career__checkbox__child">
                              <input
                                ...
                                className="checkbox"
                              />
                              <label htmlFor="checkbox23" className="label">
                                Design Intern
                              </label>
                            </div>
                          </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-4 nopadding">
                          <div className="career__checkbox__parent">
                            <div className="career__checkbox__child">
                              ...
                              />
                              <label htmlFor="checkbox24" className="label">
                                Frontend Developer
                              </label>
                            </div>
                          </div>
                          ...
                          <div className="career__textbox__parent">
                            <div className="career__checkbox__child">
                              <input
                                ...
                                className="checkbox"
                              />
                              <label htmlFor="checkbox26" className="label">
                                Backend Developer
                              </label>
                            </div>
                          </div>
                          ...
                          <div className="career__textbox__parent">
                            <div className="career__checkbox__child">
                              <input
                                ...
                                className="checkbox"
                              />
                              <label htmlFor="checkbox29" className="label">
                          ...
                          <div className="career__checkbox__parent">
                            <div className="career__checkbox__child">
                              <input
                                ...
                                value="Social Media Guru"
                              />
                              <label htmlFor="checkbox30" className="label">
                                Social Media Guru
                              </label>
                            </div>
                          </div>
                          ...
                          <div className="career__textbox__parent">
                            <div className="career__checkbox__child">
                              <input
                                ...
                                className="checkbox"
                              />
                              <label htmlFor="checkbox31" className="label">
                                Influencer
                              </label>
                            </div>
                          </div>
                          ...
                          <div className="career__textbox__parent">
                            <div className="career__checkbox__child">
                              <input
                                ...
                                className="checkbox"
                              />
                              <label htmlFor="checkbox32" className="label">
                                Content Writer
                              </label>
                            </div>
                          </div>
                  ...
                  <div className="career__description">
                    ...
                    <textarea
                      ...
                      className="textarea__input raleway"
                      name="career__desc"
                    ></textarea>
                  </div>
                  ...
                  <div className="career__submit">
                    <input
                      type="submit"
                      value="Submit"
                      className="submit bg__black text-white"
                    />
                  </div>
                </form>
              </div>
