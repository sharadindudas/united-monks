                    ...
                    <div className="row">
                        <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                            <div className="copyright__text">
                                <span className="green">
                                    Copyright &copy; 2019 United Monks, All
                                    Rights Reserved
                                </span>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6 nopadding">
                            <div className="copyright__socials">
                                <a
                                    href="https://www.facebook.com/unitedmonksco"
                                    className="social_icon__container"
                                    aria-label="Facebook"
                                >
                                ...
                                <a
                                    href="https://www.instagram.com/unitedmonksco/"
                                    className="social_icon__container"
                                ...
                                <a
                                    href="https://www.behance.net/unitedmonksco"
                                    className="social_icon__container"
                                    aria-label="Behance"
                                >
                                ...
                                <a
                                    href="https://www.linkedin.com/company/unitedmonksco/"
                                    className="social_icon__container"
                                    aria-label="Linkedln"
                                >
